...
?>
    ...
    <body>
        <header>
            <?php
                include("../../../vista/header/headerAfiliado_com.php")
            ?>
        </header>
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  -->
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  -->
        <div onclick="ocultarMenu()"><!--en este contenedor se hace click y se oculta el menu responsive, la función ocultarMEnu e encuentra en Funciones_varias.js--> 
            <div class="Perfil_00_A"> 
                <?php 
                    //Consulta para para colocar el nombre y apellido del afiliado que esta siendo visitado
                    $consulta_2="SELECT * FROM imagenes WHERE ID_AfiliadoCom= '$sesion' ";
                    $Recorset_2=mysqli_query($conexion,$consulta_2);
                    $Afiliado_2= mysqli_fetch_array($Recorset_2); 
                    // echo $Afiliado_2['nombre_imagen'];
                ?>
                <div id="Perfil_1">
                    <div  class="imagen_Div">                
                       <img class="imagen" src="../images/<?php echo $Afiliado_2['nombre_imagen'];?>" >
                    </div>
                </div> 
            </div>
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////  -->
