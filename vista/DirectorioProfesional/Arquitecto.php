...
?>
    ...
    <html lang="es">
    <head>
		<title>Perfil Arquitecto</title>
		<meta charset="utf-8"/>
		<meta name="description" content="perfil de arquitecto"/>
		<meta name="keywords" content="perfil arquitecto"/>
...
<!-- LOGROS -->
            <div id="Perfil_3">
                ...
                <div class="mostrar_1">
                    <textarea class="A_10" id="PerfilProfesional_3"><?php echo $PerfilAfiliado['servicio_6'];?></textarea>
                    <figure>
                ...
                <ul>  
                    <?php
                        if(!empty($PerfilAfiliado['servicio_1'])){  ?>
                            <li class="A_08" type="text" name="servicioUno"><?php echo $PerfilAfiliado['servicio_1'];?></li>  <?php
                        } 
                        if(!empty($PerfilAfiliado['servicio_2'])){  ?>                    
                            <li class="A_08" type="text" name="servicioUno"><?php echo $PerfilAfiliado['servicio_2'];?></li>  <?php
                        } 
                        if(!empty($PerfilAfiliado['servicio_3'])){  ?>
                            <li class="A_08" type="text" name="servicioUno"><?php echo $PerfilAfiliado['servicio_3'];?></li>  <?php
                        } 
                        if(!empty($PerfilAfiliado['servicio_4'])){ ?>
                            <li class="A_08" type="text" name="servicioUno"><?php echo $PerfilAfiliado['servicio_4'];?></li>  <?php
                        } 
                    ?> 
                </ul>
            </div>
